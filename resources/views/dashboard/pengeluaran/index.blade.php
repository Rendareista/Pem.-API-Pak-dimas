...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="table-responsive-medium col-lg-10">
            <a href="/dashboard/pengeluaran/create" class="btn btn-primary mb-3">Add New Note</a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input autocomplete="off" type="date" class="form-control" name="mulai_tanggal" value="{{ old('mulai_tanggal') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group">
                            <div class="input-group-text">Sampai Tanggal</div>
                            <input autocomplete="off" type="date" class="form-control" name="sampai_tanggal" value="{{ old('sampai_tanggal') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
            ...
            <table class="table table-striped table-responsive-sm mt-3">
                ...
                <tbody>
                    @foreach ($pengeluarans as $collect)
                    <tr>
                ...
                <tfoot>
                    <tr class="table-info">
                        ...
                        <td class="text-center">Rp. {{ number_format($totaloutcome) }},-</td>
